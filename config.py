...
OWNER_USERNAME = getenv("OWNER_USERNAME","devil_5520")
BOT_USERNAME = getenv("BOT_USERNAME" , "PROFESSIONAL_MUSIC_BOT")
BOT_NAME = getenv("BOT_NAME" , "PROFESSIONAL_MUSIC_BOT")
ASSUSERNAME = getenv("ASSUSERNAME" , "Devil_35520")
MONGO_DB_URI = getenv("MONGO_DB_URI", None)
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
LOGGER_ID = int(getenv("LOGGER_ID", -1002455401191))
OWNER_ID = int(getenv("OWNER_ID", 7544115235))
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Bloodlinebots/shizukaradheka.git",)
